...
# About the Project
It was developed for fun and as an introduction to the implementation of statistics and probability in code. The main purpose is to introduce myself to stat/probability and to strengthen my object-oriented programming skills.
